...
public class XRSurfaceController : MonoBehaviour {
  ...
  private const float GROUND_DISTANCE_GUESS = 1f; //it was 1.2// ~4ft
  ...
  public Dictionary<long, Vector3> centerMap;
  ...
  private void Initialize() {
    ...
    if (!displayImmediately) {
      //SetHidden(true); // TODO Uncoment this one to reset to default
